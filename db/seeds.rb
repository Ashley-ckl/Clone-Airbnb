...
concert_hall = Space.new(user: meder, capacity: "500+", price_per_hour: 100, amenities: "Buffet, Waiting Staff", name: "Concert Hall", location: "Carrer del Comerc, Barcelona", description:"The building is rectangular shaped. The house is half surrounded by a covered patio.
...
party_room.save
banquet_hall = Space.new(user: ricardo, capacity: "100 to 200", price_per_hour: 150, amenities: "Kitchen, Band, Waiting Staff", name: "Banquet Hall", location: "Carrer den Grassot, Barcelona",  description:"From the outside this house looks intimate and cozy. It has been built with cypress wood and has burgandy brick decorations. Small, half rounded windows allow enough light to enter the home and have been added to the house in a mostly symmetric way.")
...
private_house.save
boat = Space.new(user: ricardo, capacity: "100 to 300", price_per_hour: 400, amenities: "sundeck, open bar, umbrellas, chairs, towels", name: "Private Boat", location: "Ronda del port, Barcelona",  description:"Amazing boat for your private parties, enjoy the best views")
boat.remote_photo_url = "https://www.thewhiteisle.co.uk/wp-content/uploads/2017/02/pukka-800x533.jpeg"
boat.save
loft = Space.new(user: kristine, capacity: "up to 20", price_per_hour: 50, amenities: "couches, pool table, bar, tables & chairs", name: "City Center Loft", location: "La Rambla, Barcelona",  description:"High ceilings, open spaces, exposed building materials and big windows.")
...
loft.save
roof = Space.new(user: meder, capacity: "200 to 500", price_per_hour: 300, amenities: "lounge chairs, pool, open bar, security guard", name: "Rooftop Terrace", location: "Carrer de Blai, Barcelona",  description:"There is no better place to be at sunset than sipping a cocktail on one of Barcelona’s ultra-chic roof bars.")
